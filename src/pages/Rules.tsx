  ...
  return (
    <div className="min-h-screen bg-[#f8fafb] text-gray-900 pb-16 md:pb-0">
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 pb-14 sm:pb-20">
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm min-h-[340px] sm:min-h-[480px] flex flex-col items-center justify-center gap-4 text-center p-8 sm:p-10">
